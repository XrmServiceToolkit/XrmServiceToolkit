...
*       New Behaviour - XrmServiceToolkit.Soap.AddNotification is working with CRM 2013 using the out-of-box functionality. Still support CRM 2011
...
*    Changes:
*       New Behaviour - XrmServiceToolkit.Soap.Fetch method will allow 'page' and 'count' parameter to limit the returned records.
...
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(["XrmServiceToolkit"], factory);
    } else if (typeof module === "object" && typeof module.exports === "object" && module.exports != null) {
        module.exports = global.document ?
            factory(global, true) :
            function (w) {
                if (!w.document) {
                    throw new Error("XrmServiceToolkit requires a window with a document");
                }
                return factory(w);
            };
    } else {
...
} (typeof window !== "undefined" ? window : this, function (window, dontExpose) {
    ...
    if (!dontExpose) {
        window.XrmServiceToolkit = XrmServiceToolkit;
    }

    return XrmServiceToolkit;
}));